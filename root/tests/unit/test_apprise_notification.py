...
class TestAppriseNotificationFailures(unittest.TestCase):
    ...
    @patch("apprise_notification.apprise.Apprise")
    @patch("config_models.ConfigManager.load_config")
    def test_pushbullet_device_not_found(self, mock_load_config, MockGlobalApprise, mock_requests_get, mock_log_debug):
        ...
        mock_response.json.return_value = {
            "devices": [
                {"iden": "device1", "active": True, "pushable": True, "nickname": "other_device"}
            ]
        }
    ...
    @patch("apprise_notification.apprise.Apprise")
    @patch("config_models.ConfigManager.load_config")
    def test_apprise_configuration_exception(self, mock_load_config, MockGlobalApprise, mock_requests_get, mock_log_failure):
    ...
    @patch("apprise_notification.apprise.Apprise")
    @patch("config_models.ConfigManager.load_config")
    def test_apprise_url_add_failure(self, mock_load_config, MockGlobalApprise, mock_log_failure):
        ...
        failure_calls = [call for call in mock_log_failure.call_args_list 
                        if "Failed to add Apprise URL:" in str(call)]
        self.assertTrue(len(failure_calls) > 0, "Should log at least one URL addition failure")
    ...
    @patch("apprise_notification.apprise.Apprise")
    @patch("config_models.ConfigManager.load_config")
    def test_no_valid_urls_after_processing(self, mock_load_config, MockGlobalApprise, mock_log_failure):
...
class TestAppriseNotificationAdditionalCoverage(unittest.TestCase):
    ...
    @patch("apprise_notification.apprise.Apprise")
    @patch("config_models.ConfigManager.load_config")
    def test_pushbullet_device_found_success(self, mock_load_config, MockGlobalApprise, mock_requests_get, mock_log_debug):
        ...
        mock_response.json.return_value = {
            "devices": [
                {"iden": "device1", "active": True, "pushable": True, "nickname": "other_device"},
                {"iden": "device2", "active": True, "pushable": True, "nickname": "target_device"}
            ]
        }
        mock_requests_get.return_value = mock_response
    ...
    @patch("apprise_notification.apprise.Apprise")
    @patch("config_models.ConfigManager.load_config")
    def test_pushbullet_url_already_present(self, mock_load_config, MockGlobalApprise, mock_log_debug):
